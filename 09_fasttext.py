...
present_words = [w for w in selected_words if w in fasttext_model.wv]

# Prepare vectors for selected words
vectors = [fasttext_model.wv[word] for word in present_words]
...
ax.set_title("FastText Embeddings (with PCA)")
